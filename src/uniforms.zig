const shd_quad = @import("quad_shader");
const zm = @import("zm");
const Mat4 = zm.Mat4f;
...
pub const Transform = struct {
    ...
    pub fn updateZoom(self: *Transform, zoom: Zoom) void {
        ...
        //     .{ x, y, 0.0, 1.0 },
        // };
        self.zoom.data[0] = zoom.k;
        self.zoom.data[5] = zoom.k;
        self.zoom.data[12] = zoom.x;
        self.zoom.data[13] = zoom.y;
    }
    ...
    pub fn computeVSParams(self: Transform) shd_quad.VsParams {
        return .{
            .zoom = self.zoom.data,
            .window_scale = self.window_scale.data,
            .untransform = self.untransform.data,
        };
    }
};
