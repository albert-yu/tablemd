...
//
//    Cmdline:
//        sokol-shdc --input src/shaders/sfons.glsl --output src/shaders/sfons.glsl.zig -l glsl410:metal_macos:hlsl5:glsl300es:wgsl -f sokol_zig --reflection
//
//    Overview:
//    =========
//    Shader program: 'sfontstash':
//        Get shader desc: shd.sfontstashShaderDesc(sg.queryBackend());
//        Vertex Shader: vs
//        Fragment Shader: fs
//        Attributes:
...
//            Bind slot: SMP_smp => 0
//
pub const ATTR_sfontstash_position = 0;
pub const ATTR_sfontstash_texcoord0 = 1;
pub const ATTR_sfontstash_color0 = 2;
pub const ATTR_sfontstash_psize = 3;
...
//
//
const vs_source_glsl410 = [520]u8 {
...
//
//
const vs_source_glsl300es = [481]u8 {
...
pub fn sfontstashShaderDesc(backend: sg.Backend) sg.ShaderDesc {
...
pub fn sfontstashAttrSlot(attr_name: []const u8) ?usize {
...
pub fn sfontstashImageSlot(img_name: []const u8) ?usize {
    if (std.mem.eql(u8, img_name, "tex")) {
        return 0;
    }
    return null;
}
pub fn sfontstashSamplerSlot(smp_name: []const u8) ?usize {
    if (std.mem.eql(u8, smp_name, "smp")) {
        return 0;
    }
    return null;
}
pub fn sfontstashUniformblockSlot(ub_name: []const u8) ?usize {
    if (std.mem.eql(u8, ub_name, "vs_params")) {
        return 0;
    }
    return null;
}
pub fn sfontstashUniformblockSize(ub_name: []const u8) ?usize {
    if (std.mem.eql(u8, ub_name, "vs_params")) {
        return @sizeOf(VsParams);
    }
    return null;
}
pub fn sfontstashUniformOffset(ub_name: []const u8, u_name: []const u8) ?usize {
    if (std.mem.eql(u8, ub_name, "vs_params")) {
        if (std.mem.eql(u8, u_name, "mvp")) {
            return 0;
        }
        if (std.mem.eql(u8, u_name, "tm")) {
            return 64;
        }
    }
    return null;
}
pub fn sfontstashUniformDesc(ub_name: []const u8, u_name: []const u8) ?sg.GlslShaderUniform {
    if (std.mem.eql(u8, ub_name, "vs_params")) {
        if (std.mem.eql(u8, u_name, "mvp")) {
...
pub fn sfontstashStoragebufferSlot(sbuf_name: []const u8) ?usize {
    _ = sbuf_name;
    return null;
}
