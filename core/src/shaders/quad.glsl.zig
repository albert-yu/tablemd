...
const vs_source_glsl410 = [742]u8 {
    ...
    0x20,0x20,0x20,0x20,0x75,0x76,0x20,0x3d,0x20,0x5f,0x35,0x37,0x3b,0x0a,0x20,0x20,
...
//
//
const vs_source_glsl300es = [703]u8 {
    ...
    0x35,0x36,0x32,0x35,0x29,0x20,0x2a,0x20,0x30,0x2e,0x30,0x30,0x32,0x30,0x30,0x30,
    0x30,0x30,0x30,0x30,0x39,0x34,0x39,0x39,0x34,0x39,0x30,0x32,0x36,0x31,0x30,0x37,
    0x37,0x38,0x38,0x30,0x38,0x35,0x39,0x33,0x37,0x35,0x29,0x2c,0x20,0x30,0x2e,0x30,
    0x2c,0x20,0x30,0x2e,0x30,0x29,0x29,0x3b,0x0a,0x20,0x20,0x20,0x20,0x75,0x76,0x20,
    0x3d,0x20,0x5f,0x35,0x37,0x3b,0x0a,0x20,0x20,0x20,0x20,0x63,0x6f,0x6c,0x6f,0x72,
...
//        gl_Position = mul(float4(instance_position.x, instance_position.y, 1.0f, 1.0f) + float4(_57 * (exp(log(_13_zoom[0].x) * 0.00999999977648258209228515625f) * 0.00200000009499490261077880859375f), 0.0f, 0.0f), mul(_13_window_scale, mul(_13_zoom, _13_untransform)));
//        uv = _57;
//        color = color0;
//    }
//
...
const vs_source_hlsl5 = [1363]u8 {
    ...
    0x66,0x29,0x20,0x2a,0x20,0x30,0x2e,0x30,0x30,0x32,0x30,0x30,0x30,0x30,0x30,0x30,
    0x30,0x39,0x34,0x39,0x39,0x34,0x39,0x30,0x32,0x36,0x31,0x30,0x37,0x37,0x38,0x38,
    0x30,0x38,0x35,0x39,0x33,0x37,0x35,0x66,0x29,0x2c,0x20,0x30,0x2e,0x30,0x66,0x2c,
    0x20,0x30,0x2e,0x30,0x66,0x29,0x2c,0x20,0x6d,0x75,0x6c,0x28,0x5f,0x31,0x33,0x5f,
    0x77,0x69,0x6e,0x64,0x6f,0x77,0x5f,0x73,0x63,0x61,0x6c,0x65,0x2c,0x20,0x6d,0x75,
    0x6c,0x28,0x5f,0x31,0x33,0x5f,0x7a,0x6f,0x6f,0x6d,0x2c,0x20,0x5f,0x31,0x33,0x5f,
    ...
    0x6e,0x3b,0x0a,0x20,0x20,0x20,0x20,0x69,0x6e,0x73,0x74,0x61,0x6e,0x63,0x65,0x5f,
...
//        out.gl_Position = ((_13.untransform * _13.zoom) * _13.window_scale) * (float4(in.instance_position.x, in.instance_position.y, 1.0, 1.0) + float4(_57 * (exp(log(_13.zoom[0].x) * 0.00999999977648258209228515625) * 0.00200000009499490261077880859375), 0.0, 0.0));
//        out.uv = _57;
//        out.color = in.color0;
//        return out;
//    }
//
//
const vs_source_metal_macos = [948]u8 {
    ...
    0x39,0x33,0x37,0x35,0x29,0x2c,0x20,0x30,0x2e,0x30,0x2c,0x20,0x30,0x2e,0x30,0x29,
    0x29,0x3b,0x0a,0x20,0x20,0x20,0x20,0x6f,0x75,0x74,0x2e,0x75,0x76,0x20,0x3d,0x20,
    0x5f,0x35,0x37,0x3b,0x0a,0x20,0x20,0x20,0x20,0x6f,0x75,0x74,0x2e,0x63,0x6f,0x6c,
...
//      k = x_33;
//      let x_35 : f32 = k;
//      size = (exp((log(x_35) * 0.00999999977648258209f)) / 500.0f);
...
const vs_source_wgsl = [1802]u8 {
    ...
    0x36,0x34,0x38,0x32,0x35,0x38,0x32,0x30,0x39,0x66,0x29,0x29,0x20,0x2f,0x20,0x35,
