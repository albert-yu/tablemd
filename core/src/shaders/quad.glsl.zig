...
//    void main()
//    {
//        if (distance(uv, vec2(0.5)) > 0.4000000059604644775390625)
//        {
//            discard;
//        }
//        frag_color = color;
...
const fs_source_glsl410 = [260]u8 {
    ...
    0x20,0x76,0x65,0x63,0x32,0x28,0x30,0x2e,0x35,0x29,0x29,0x20,0x3e,0x20,0x30,0x2e,
...
const fs_source_glsl300es = [285]u8 {
    ...
    0x2e,0x35,0x29,0x29,0x20,0x3e,0x20,0x30,0x2e,0x34,0x30,0x30,0x30,0x30,0x30,0x30,
...
//    void frag_main()
//    {
//        if (distance(uv, 0.5f.xx) > 0.4000000059604644775390625f)
//        {
//            discard;
//        }
//        frag_color = color;
...
const fs_source_hlsl5 = [596]u8 {
    ...
    0x65,0x28,0x75,0x76,0x2c,0x20,0x30,0x2e,0x35,0x66,0x2e,0x78,0x78,0x29,0x20,0x3e,
...
//    {
//        main0_out out = {};
//        if (distance(in.uv, float2(0.5)) > 0.4000000059604644775390625)
//        {
//            discard_fragment();
//        }
...
const fs_source_metal_macos = [454]u8 {
    ...
    0x6c,0x6f,0x61,0x74,0x32,0x28,0x30,0x2e,0x35,0x29,0x29,0x20,0x3e,0x20,0x30,0x2e,
    0x34,0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x35,0x39,0x36,0x30,0x34,0x36,0x34,0x34,
    0x37,0x37,0x35,0x33,0x39,0x30,0x36,0x32,0x35,0x29,0x0a,0x20,0x20,0x20,0x20,0x7b,
    0x0a,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x64,0x69,0x73,0x63,0x61,0x72,0x64,
...
const fs_source_wgsl = [753]u8 {
    ...
    0x6e,0x74,0x65,0x72,0x20,0x3d,0x20,0x76,0x65,0x63,0x32,0x66,0x28,0x30,0x2e,0x35,
    0x66,0x2c,0x20,0x30,0x2e,0x35,0x66,0x29,0x3b,0x0a,0x20,0x20,0x6c,0x65,0x74,0x20,
