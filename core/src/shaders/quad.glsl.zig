...
//
//
const vs_source_glsl410 = [267]u8 {
    ...
    0x75,0x76,0x20,0x3d,0x20,0x76,0x65,0x63,0x32,0x28,0x70,0x6f,0x73,0x69,0x74,0x69,
...
//    void main()
//    {
//        if (distance(uv, vec2(0.0)) > 0.4000000059604644775390625)
//        {
//            discard;
//        }
//        frag_color = color;
...
//
//
const fs_source_glsl410 = [260]u8 {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x34,0x31,0x30,0x0a,0x0a,0x6c,0x61,
    0x79,0x6f,0x75,0x74,0x28,0x6c,0x6f,0x63,0x61,0x74,0x69,0x6f,0x6e,0x20,0x3d,0x20,
...
//
//
const vs_source_glsl300es = [228]u8 {
    ...
    0x69,0x6f,0x6e,0x3b,0x0a,0x20,0x20,0x20,0x20,0x75,0x76,0x20,0x3d,0x20,0x76,0x65,
    0x63,0x32,0x28,0x70,0x6f,0x73,0x69,0x74,0x69,0x6f,0x6e,0x2e,0x78,0x2c,0x20,0x70,
...
//
//
const fs_source_glsl300es = [285]u8 {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x30,0x30,0x20,0x65,0x73,0x0a,
    ...
    0x2e,0x30,0x29,0x29,0x20,0x3e,0x20,0x30,0x2e,0x34,0x30,0x30,0x30,0x30,0x30,0x30,
...
const vs_source_hlsl5 = [757]u8 {
    ...
    0x20,0x20,0x75,0x76,0x20,0x3d,0x20,0x66,0x6c,0x6f,0x61,0x74,0x32,0x28,0x70,0x6f,
    0x73,0x69,0x74,0x69,0x6f,0x6e,0x2e,0x78,0x2c,0x20,0x70,0x6f,0x73,0x69,0x74,0x69,
    0x6f,0x6e,0x2e,0x79,0x29,0x3b,0x0a,0x20,0x20,0x20,0x20,0x63,0x6f,0x6c,0x6f,0x72,
...
//    void frag_main()
//    {
//        if (distance(uv, 0.0f.xx) > 0.4000000059604644775390625f)
//        {
//            discard;
//        }
//        frag_color = color;
...
const fs_source_hlsl5 = [596]u8 {
    ...
    0x36,0x34,0x34,0x37,0x37,0x35,0x33,0x39,0x30,0x36,0x32,0x35,0x66,0x29,0x0a,0x20,
...
const vs_source_metal_macos = [501]u8 {
    ...
    0x66,0x6c,0x6f,0x61,0x74,0x32,0x28,0x69,0x6e,0x2e,0x70,0x6f,0x73,0x69,0x74,0x69,
    0x6f,0x6e,0x2e,0x78,0x2c,0x20,0x69,0x6e,0x2e,0x70,0x6f,0x73,0x69,0x74,0x69,0x6f,
    0x6e,0x2e,0x79,0x29,0x3b,0x0a,0x20,0x20,0x20,0x20,0x6f,0x75,0x74,0x2e,0x63,0x6f,
...
//    {
//        main0_out out = {};
//        if (distance(in.uv, float2(0.0)) > 0.4000000059604644775390625)
//        {
//            discard_fragment();
//        }
...
//
//
const fs_source_metal_macos = [454]u8 {
    0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,0x20,0x3c,0x6d,0x65,0x74,0x61,0x6c,0x5f,
    0x73,0x74,0x64,0x6c,0x69,0x62,0x3e,0x0a,0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,
    0x20,0x3c,0x73,0x69,0x6d,0x64,0x2f,0x73,0x69,0x6d,0x64,0x2e,0x68,0x3e,0x0a,0x0a,
    0x75,0x73,0x69,0x6e,0x67,0x20,0x6e,0x61,0x6d,0x65,0x73,0x70,0x61,0x63,0x65,0x20,
...
//      gl_Position = x_18;
//      let x_27 : f32 = position_1.x;
//      let x_29 : f32 = position_1.y;
//      uv = vec2f(x_27, x_29);
//      let x_33 : vec4f = color0;
//      color = x_33;
//      return;
//    }
//
...
const vs_source_wgsl = [765]u8 {
    ...
    ,
...
//      radius = 0.40000000596046447754f;
//      let x_21 : f32 = dist;
//      let x_22 : f32 = radius;
//      if ((x_21 > x_22)) {
//        discard;
...
const fs_source_wgsl = [753]u8 {
    ...
    0x20,0x72,0x61,0x64,0x69,0x75,0x73,0x20,0x3d,0x20,0x30,0x2e,0x34,0x30,0x30,0x30,
    ...
    ,
